...
\noindent
The later work always lifts machine code to an IR before type analysis. Lee et al. in TIE~\cite{lee_tie_2011} had the same idea of using subtyping lattice,
...
\emph{low-level polymorphism} problem.
...
Retypd uses subtyping in almost all derived constraints,
