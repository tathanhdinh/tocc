...
(in constrast with Mycroft's \emph{constraint based}) approach where type information of an object will be refined gradually,
...
(adding integer to pointer does not result in pointer of the same type) and
