...
of our knowledge, there is only little effort in hiding type information. The most related research that we
...
Type flattening obfuscation is very lightweight, between the compiled binaries without and
with type flattening, the later incurs only a small code size and runtime overhead; more sophisticated obfuscation can be added as an option.
Though we only focus on type flattening for primitive types and function signatures,
the method can easily extended for complex types.
