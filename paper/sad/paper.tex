...
\emph{type capability} model where each type variable is attached with several labels representing it
...
\begin{figure}[h]
  ...
  \begin{tikzcd}
    ...
    \mathtt{p}
  \end{tikzcd}
  \caption{Tree model of $\tau_{p}.\mathtt{load}$, the type of $*p$.}
\end{figure}
