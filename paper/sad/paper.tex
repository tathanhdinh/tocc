...
always with some storage primitives, there are no essential differences between types and
...
\emph{refinement type} should not leave storage traces. Moreover, the survey lacks some important
papers which are only published later~\cite{noonan_polymorphic_2016,robbins_minx_2016}.
...
Mycroft~\cite{mycroft_type-based_1999} in his interest of decompilation. The basic idea is very
...
since adding two pointers is forbidden in C.
