...
type qualifier (\texttt{\small const}, \texttt{\small volatile}), and in general any
...
Though only giving poor results about types, this approach has advantages: the decompilation is always 
possible after raising, the type system contains basic types being mapped from IR types with casts.
...
TIE has troubles in deriving type constraints for $x$ and $y$, as with the case of symbolic constants, 
e.g. with $x$
\begin{equation*}
