...
inverse $Q = P^{-1}$ (see~\cref{fig:invertiblepolynomial} for example), the aliases of
some value $v$ is $Q(P(v))$. The calculation of $Q(P(v))$ is embedded into the binary code.
